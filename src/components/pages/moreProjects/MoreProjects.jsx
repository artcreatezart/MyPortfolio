...
import '../moreProjects/moreProjects.scss'
...
export const portfolioProjects = [
    ...
    },
    {
      id: 11,
      name: 'EMK Website',
      mockupImage1: '/img/projectArrayImg/talarmiamockup.webp',
      type: ['Web Development', 'UX & UI Design', 'Branding'],
      image2: '/img/projectArrayImg/emk1.webp',
        image3: '/img/projectArrayImg/emk2.webp',
        image4: '/img/projectArrayImg/emk3.webp',
        image5: '/img/projectArrayImg/emk4.webp',
        image6: '/img/projectArrayImg/emk5.webp',
        image7: '',
      date: '2026',
      credit: '',
      aboutdescription: 'This project was to create website to promote a upstarting small buisness called Talarmia (Kinesiology and Wellness). Offering services such as EMK and reiki this website was to reflect, calm, peaceful and simple elements of this buisness while also showing the services and how to book appointments. To evoke what this buisness was, was done through not only the graphic design but also the structual design of the website and how elements fitted together.',
      processDescription: 'For this website, I researched about the typography, graphic, colour, and information about the EMK world. While also meeting with the client to discuss their vision and requirements. After doing all the research, I looked into wireframes, and designs of not only the graphics but also the users experience of the website. I created the logo for the brand and built of the website stepping stones of those ideas to create consisitency and clarity for customers to feel at ease when navigating the website.',
      github: 'https://github.com/artcreatezart',
      vercel: 'https://www.talarmia.com/',
      tools: '',
      hardSkills: 'SquareSpace - Procreate - Drive - Canva',
      softSkills: 'Creativity - Time Management - Client Communication',
    },
    {
      id: 15,
      name: 'EMK Brochure',
      mockupImage1: '/img/projectArrayImg/emkbrochuremockup.webp',
      type: ['Branding'],
      image2: '/img/projectArrayImg/emkbrochure1.webp',
        image3: '/img/projectArrayImg/emkbrochure2.webp',
        image4: '/img/projectArrayImg/emkbrochure3.webp',
        image5: '/img/projectArrayImg/emkbrochure4.webp',
        image6: '/img/projectArrayImg/emkbrochure5.webp',
        image7: '',
      date: '2026',
      credit: '',
      aboutdescription: 'This project was to create website to promote a upstarting small buisness called Talarmia (Kinesiology and Wellness). Offering services such as EMK and reiki this brochure pamplet was to reflect, calm, peaceful and simple elements of this buisness to possible customers to promote engagment. To evoke what this buisness was, was done through not only the graphic design but also the flow of information and capturing key info.',
      processDescription: 'For this brochure pamplet, I researched about the typography, graphic, colour, and information about the EMK world. While also meeting with the client to discuss their vision and requirements. After doing all the research, I looked into wireframes, and designs of not only the graphics but also the users experience of the website. Keeping in communication while bringing a consistency between the website and branding i have previously created.',
      github: 'https://github.com/artcreatezart',
      vercel: 'https://www.talarmia.com/',
      tools: '',
      hardSkills: 'SquareSpace - Procreate - Drive - Canva',
    ...
    {
      id: 13,
      name: 'Ernestos Promotionals',
      mockupImage1: '/img/projectArrayImg/ernestosmockup.webp',
      type: ['Web Development', 'Graphic Design'],
      image2: '/img/projectArrayImg/ernestosimg1.webp',
        image3: '/img/projectArrayImg/ernestosimg2.webp',
        image4: '/img/projectArrayImg/ernestosimg3.webp',
        image5: '/img/projectArrayImg/ernestosimg4.webp',
        image6: '/img/projectArrayImg/ernestosimg5.webp',
        image7: '/img/projectArrayImg/ernestosimg6.webp',
      date: ['2025', '2026'],
      credit: '',
      aboutdescription: 'During my time at Ernesto’s, I worked across a variety of design, digital, and promotional projects, including menu redesigns, website updates, social media content, Reels, Stories, events, and nationwide campaigns. I worked closely with the team to create a cohesive brand across digital and in-venue experiences while developing my skills in design, content creation, and marketing. I was also part of the team that won the Rum Co & Fiji competition, contributing to social media and in-venue promotions alongside the teams cocktail creations. !!For a look at more of the content, campaigns, events and social work I created during my time at Ernesto’s, check out @ernestoswellington on Instagram and explore the posts from before 5th May.',
      processDescription: 'For these creative projects, I worked closely with the team and owner, often managing last-minute tasks and working quickly to gather content and create promotional material. I would take information from the owner, establish priorities and timelines, and shift focus when more urgent tasks came up. Customer feedback also helped shape our direction, allowing us to combine ideas and analysis to determine the next steps. Clear communication with the team and owner ensured we stayed aligned and worked towards the same goal.',
      github: 'https://github.com/artcreatezart',
      vercel: 'https://vercel.com/abbies-projects-93142625',
      tools: '',
      hardSkills: 'SquareSpace - Procreate - Drive - Canva - Microsoft',
      softSkills: 'Feedback Analysis - Creativity - Time Management - Client Communication',
    },
    {
      id: 10,
    ...
    },
    {
      ...
      mockupImage1: '/img/projectArrayImg/halloween-poster-mockup.webp',
      type: 'Graphic Design',
      image2: '',
        image3: '',
        image4: '',
      ...
      date: '2025',
      credit: '',
      aboutdescription: 'This project was to create a poster to promote a Halloween Movie Night Event. The poster was to reflect the spooky and fun elements of Halloween while also showing the event details. To evoke what this event was, was done through not only the graphic design but also the layout and how elements fitted together.',
      processDescription: 'For this poster design, I researched typography, colours, and modern and traditional Halloween posters. While trying to keep elements easily readable and clear, I wanted to incorporate subtle changes to the font, such as the speckly effect for a worn-out, ominous feel. I took inspiration from one of my favourite films, *The Nightmare Before Christmas*, and the character Oogie Boogie. As the poster is quite dark, it is playful, and although not bright and in your face, the colours and flow help engage viewers. This was a personal fun project, as I was able to do research and explore different ways to present a poster.',
      github: 'https://github.com/artcreatezart',
      vercel: 'https://vercel.com/abbies-projects-93142625',
      tools: 'Procreate',
      hardSkills: 'Procreate',
      softSkills: 'Creativity - Time Management - Research',
    },
    {
        id: 5,
        ...
        disclaimer: 'I am currently working on this project to improve the design and functionailty using new skills have learnt. At this moment i am working on cleaning up the layout and working on functionality.',
    ...
    //   credit: '',
    //   aboutdescription: 'This project was to create website to promote a upstarting small buisness called Talarmia (Kinesiology and Wellness). Offering services such as EMK and reiki this website was to reflect, calm, peaceful and simple elements of this buisness while also showing the services and how to book appointments. To evoke what this buisness was, was done through not only the graphic design but also the structual design of the website and how elements fitted together.',
    //   processDescription: 'For this website, I researched about the typography, graphic, colour, and information about the EMK world. While also meeting with the client to discuss their vision and requirements. After doing all the research, I looked into wireframes, and designs of not only the graphics but also the strucutral side of the website. Alot of testing, feedback analysing, adjustments and developments lead to the end success of this product. I also was really excited to be able to incoporate alot of hand crafted elements to this packaging as this fictional world was based with magic and alot of hand crafted tools I really wanted to be able to show that throught this design. So i created a stamp the shop would use to brand their logo onto the final packaging, a handwritten note from the forager who gathered the stone and details about that specific stone for the product. Aswell as a sewn strip of fabric to wrap the necklace and a sewn pillow of sort for the necklace to sit in the box.',
    //   github: 'https://github.com/artcreatezart',
    //   vercel: 'https://vercel.com/abbies-projects-93142625',
    //   tools: '',
    //   hardSkills: 'Procreate - Drive - Canva',
    //   softSkills: 'Creativity - Time Management - Client Communication',
    // }
    ...
    },
    {
      id: 8,
      name: 'HUHA Website',
      mockupImage1: '/img/projectArrayImg/huhamockup.webp',
      type: ['Web Development', 'Ux Design'],
            ...
            <Link to={`/project/${project.id}`} key={project.id} className="project-link">
              <div className="project-card">
                ...
                <div className='project-card-img-details'>
                  ...
                  <button className='see-more-button'>View Project  →</button>
                </div>
              </div>
            </Link>
          ))}
