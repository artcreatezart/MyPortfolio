...
export const portfolioProjects = [
    ...
    },
    {
      ...
      date: '2023',
      credit: '',
      aboutdescription: 'This project involved creating packaging for an Adderstone necklace from a fictional world called "Ancient Magis Bride." The packaging was designed to reflect the preciousness of the stone while highlighting its earthy and magical elements. To convey the essence of the necklace, I focused not only on the graphic design but also on the structural design of the packaging, ensuring that all elements fitted together.',
      processDescription: 'For this packaging design, I researched typography, graphics, color, and structural elements from both the fictional world and modern influences. I explored how resources would be ethically collected in this fictional setting and considered the processing of materials to ensure the final packaging had minimal long-term negative effects on the environment. After completing my research, I developed wireframes and designs that showed both the graphics and structural aspects of the packaging. A lot of testing, feedback analysis, adjustments, and developments contributed to the successful outcome of the project. I was particularly excited to incorporate handcrafted elements, reflecting the magical and artisanal nature of this fictional world. I created a stamp for the shop to brand their logo onto the packaging, a handwritten note from the forager who gathered the stone, and details about that specific stone. Additionally, I included a sewn strip of fabric to wrap the necklace and a small sewn pillow for it to rest in within the box.',
      github: 'https://github.com/artcreatezart',
      vercel: 'https://vercel.com/abbies-projects-93142625',
