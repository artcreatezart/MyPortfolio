...
export const portfolioProjects = [
    ...
    },
    {
      ...
      image2: '/img/projectArrayImg/box2.png',
        ...
        image6: '/img/projectArrayImg/box6.png',
      date: '2023',
      credit: 'Baxter, Mia and Abbie',
      aboutdescription: 'changed the login/sign up so that it has a message that says use this password and email (Its the only one that will actually log you in)',
      processDescription: '',
      github: 'https://github.com/Miaroaming/Artie-fartie',
      vercel: 'https://artie-fartie-frontend.vercel.app/',
      tools: '',
      hardSkills: '',
      softSkills: 'Creativity',
      tools: 'Sewing Machine - Calligraphy Pen',
